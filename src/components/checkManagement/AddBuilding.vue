    ...
    <div v-show="!showPopup && !showConfirm">
      ...
      <el-table :data="tableDatas" resizable>
        ...
        <el-table-column label="操作" align="center">
          <template scope="scope">
            <el-button v-if="scope.row.type === 1" size="small" :disabled="scope.row.ispass > 4" type="success" @click="editAgency(scope.row)">通过</el-button>
            <el-button v-if="scope.row.type !== 1" size="small" :disabled="scope.row.ispass > 4" type="success" @click="editOwner(scope.row)">通过</el-button>
            <el-button size="small" :disabled="scope.row.ispass > 4" type="warning" @click="del(scope.row)">驳回</el-button>
          </template>
        </el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      getDatas () {
        this.axios({
          method: 'get',
          url: '/yewen/admin/verify/addBuildings',
          params: {
      ...
      confirm () {
        this.axios({
          method: 'post',
          url: 'yewen/admin/verify/addBuildings/ispass',
          params: {
            ispass: 6,
