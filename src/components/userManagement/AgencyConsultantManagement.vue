<template>
  <div id="AgencyConsultantManagement">
    <div v-show="!showPopup">
      ...
      <el-row>
        <el-form :model="form">
          ...
          <el-col :span="8">
            <el-input class="search" placeholder="编号、中介顾问名称" v-model="form.searchVaule">
      ...
      <el-table :data="tableDatas" resizable>
        ...
        <el-table-column label="中介顾问名称" align="center">
          <template scope="scope">
        ...
        <el-table-column label="操作" align="center">
          <template scope="scope">
            <el-button size="small" :disabled="scope.row.ispass > 1" type="success" @click="edit(scope.row)">冻结</el-button>
            <el-button size="small" :disabled="scope.row.ispass > 1" type="warning" @click="del(scope.row)">解冻</el-button>
          </template>
        </el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      getDatas () {
        this.axios({
          method: 'get',
          url: '/yewen/admin/userManage/guwenList',
          params: {
      ...
      edit (info) {
        this.axios({
          method: 'post',
          url: '/yewen/admin/verify/agency/ispass',
          params: {
            ispass: 3,
