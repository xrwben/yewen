    ...
    <div v-if="!showPopup">
      ...
      <el-table :data="activeMessageDatas" resizable border>
        ...
        <el-table-column label="操作" align="center" width="150">
          <template scope="scope">
            <el-button type="warning" size="small" @click="delMsg(scope.row.activityId)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    methods: {
      ...
      delMsg (id) {
        this.$confirm('确认删除?', '提示', {
          ...
          this.axios({
            method: 'DELETE',
            url: '/yewen/admin/activityOrMsg/delete',
            params: {
              id: id
            }
          }).then((result) => {
...
//        console.log(this.content)
        if (this.title !== '' && this.imageUrl !== '' && this.content !== '') {
          this.axios({
            method: 'post',
